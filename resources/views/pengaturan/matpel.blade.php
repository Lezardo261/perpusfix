            ...
            <div class="content border rounded border-0">
                    ...
                    <ul class=" d-flex ulcontent mt-2 ms-1" >
                        <div class=" d-flex gap-5 border border-end-0 border-start-0 border-top-0">
                            ...
                            <li><a href="{{ route('pengaturan.matpel')}}" class="list activep">Mata Pelajaran</a></li>
                        </div>
                    </ul>
                            ...
                            <tbody>
                                ...
                                <tr>
                                  ...
                                  <td class="d-flex justify-content-center">
                                      <a href="{{route('pengaturan.matpeledit', $item->id)}}" class="border rounded p-1 ps-2 pe-2 text-black me-3  ">
                                      ...
                                      <form action="" method="post" class=" p-1 ps-2 pe-2 border rounded">
                                            @csrf
                                          @method('DELETE')
                                        <a href="{{route('pengaturan.destroymatpel', $item->id)}}" class=" text-black"><i class="lni lni-trash-can"></i></a>
                                      </form>
                                  </td>
                                </tr>
